...
public class EnglishAlpha {
    ...
    static {
        mapsLower.put('1', new String[]{"1", "2", "3"});
        mapsLower.put('2', new String[]{"a", "b", "c", "2"});
        mapsLower.put('3', new String[]{"d", "e", "f", "3"});
        mapsLower.put('4', new String[]{"g", "h", "i", "4"});
        mapsLower.put('5', new String[]{"j", "k", "l", "5"});
        mapsLower.put('6', new String[]{"m", "n", "o", "6"});
        mapsLower.put('7', new String[]{"p", "q", "r", "s", "7"});
        mapsLower.put('8', new String[]{"t", "u", "v", "8"});
        mapsLower.put('9', new String[]{"w", "x", "y", "z", "9"});

        mapsUpper.put('1', new String[]{"1", "2", "3"});
        mapsUpper.put('2', new String[]{"A", "B", "C", "2"});
        mapsUpper.put('3', new String[]{"D", "E", "F", "3"});
        mapsUpper.put('4', new String[]{"G", "H", "I", "4"});
        mapsUpper.put('5', new String[]{"J", "K", "L", "5"});
        mapsUpper.put('6', new String[]{"M", "N", "O", "6"});
